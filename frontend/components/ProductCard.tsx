...
export function ProductCard({ product, onBuy }: { product: Product; onBuy: (id: number) => void }) {
  return <article className="group flex min-h-[245px] flex-col justify-between border border-ink/15 bg-white/55 p-5 transition hover:-translate-y-1 hover:border-clay hover:shadow-[6px_6px_0_rgba(179,92,62,0.12)]">
